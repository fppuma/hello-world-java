...
# DIRECTORY to
ADD . /usr/local/hello-world-java
...
RUN cd /usr/local/hello-world-java && mvn assembly:assembly
...
CMD ["java", "-cp", "/usr/local/hello-world-java/target/hello-world-java-1.0.0-SNAPSHOT-jar-with-dependencies.jar", "com.example.helloworld.HelloWorld"]